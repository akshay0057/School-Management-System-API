    ...
    public partial class Initial_Migrate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    SectionName = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    CreatedBy = table.Column<Guid>(type: "uuid", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    UpdatedBy = table.Column<Guid>(type: "uuid", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ParentMobile = table.Column<string>(type: "character varying(15)", maxLength: 15, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Students_AcademicSessions_SessionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AcademicSessions_SessionName",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FeeStructures_ClassId_EffectiveFrom",
                table: "FeeStructures",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Students_RollNo_ClassId_SectionId_SessionId",
                table: "Students",
                columns: new[] { "RollNo", "ClassId", "SectionId", "SessionId" },
                unique: true);
